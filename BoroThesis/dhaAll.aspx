<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="dhaAll.aspx.cs" Inherits="Dha007" %>
...
<h5 style="margin-left: 200px;" class="w3-jumbo w3-container w3-center w3-animate-zoom">
    ...
    <div class="w3-container w3-card-4 w3-padding-16 w3-white " style="height:auto;
        ...
        <div class="w3-container w3-center w3-animate-zoom">
            ...
            <br />
            <p>
                Here is the Graphical Repesentation of Dhaka
            </p>
            <br />
            <h3 class="w3-center">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                SelectCommand="SELECT * FROM [Dhaka]"></asp:SqlDataSource>

            <p>
                
                <asp:Button ID="Button1" runat="server" BackColor="#006600" 
                    BorderColor="#006600" Text="Max" Width="35px" /> 2014-2015
                
            </p>
            <p>
                
                <asp:Button ID="Button2" runat="server" BackColor="#CC0000" 
                    BorderColor="#CC0000" Text="Min" Width="35px" /> 2011-2012
