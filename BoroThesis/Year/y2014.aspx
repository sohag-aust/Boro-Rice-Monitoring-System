<%@ Page Title="" Language="C#" MasterPageFile="~/Year/MasterPage.master" AutoEventWireup="true" CodeFile="y2014.aspx.cs" Inherits="Year_y2014" %>
    ...
    <div class="w3-container w3-card-4 w3-padding-16 w3-white " style="height: auto;
        ...
        <div class="w3-container w3-center w3-animate-zoom">
            ...
            <h3 class="w3-center w3-xxlarge">
                Total Production 5543713.17 hector.
            </h3>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                SelectCommand="SELECT * FROM [Ban2014]"></asp:SqlDataSource>
            <p>
