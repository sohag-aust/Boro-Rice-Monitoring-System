<%@ Page Title="" Language="C#" MasterPageFile="~/Year/MasterPage.master" AutoEventWireup="true" CodeFile="comp1011.aspx.cs" Inherits="Year_comp1011" %>
 ...
 <h5 style="margin-left: 200px;" class="w3-jumbo w3-container w3-center w3-animate-zoom">
    ...
    <div class="w3-container w3-card-4 w3-padding-16 w3-white " style="height: auto;
        ...
        <div class="w3-container w3-center w3-animate-zoom">
            ...
            <br />
            <p>
                Here is the Graphical Repesentation in Comparison of production in Full Bangladesh (2010 - 2011).
            </p>
            ...
            <asp:Chart ID="Chart1" runat="server" BorderlineWidth="0" Width="800px" 
                    ...
                    <Series>
                        <asp:Series Name="Series1" XValueMember="district" YValueMembers="prevYear"
                            LegendText="2010" IsValueShownAsLabel="false" ChartArea="ChartArea1"
                            MarkerBorderColor="red">
                        </asp:Series>
 
                        <asp:Series Name="Series2" XValueMember="district" YValueMembers="currYear"
                            LegendText="2011" IsValueShownAsLabel="false" ChartArea="ChartArea1"
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                SelectCommand="SELECT * FROM [Year1011]"></asp:SqlDataSource>
            

            <br />
            
            <asp:Button ID="Button1" runat="server" BorderColor="Red" ForeColor="Red" 
                Text="Deterioration" Width="130px" /> Dhaka, Chittagong, Barisal, Rangpur
            <br />
            <br />
            <asp:Button ID="Button2" runat="server" BorderColor="#006600" 
                ForeColor="#009900" Text="Improvement" Width="130px" /> Sylhet, Khulna, Rajshahi
