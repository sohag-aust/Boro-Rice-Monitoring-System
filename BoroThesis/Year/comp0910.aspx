<%@ Page Title="" Language="C#" MasterPageFile="~/Year/MasterPage.master" AutoEventWireup="true" CodeFile="comp0910.aspx.cs" Inherits="Year_comp0910" %>
 ...
 <h5 style="margin-left: 200px;" class="w3-jumbo w3-container w3-center w3-animate-zoom">
    ...
    <div class="w3-container w3-card-4 w3-padding-16 w3-white " style="height: auto;
        ...
        <div class="w3-container w3-center w3-animate-zoom">
            ...
            <br />
            <p>
                Here is the Graphical Repesentation in Comparison of production in Full Bangladesh (2009 - 2010).
            </p>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                SelectCommand="SELECT * FROM [Year0910]"></asp:SqlDataSource>
            

            <br />
            
            <asp:Button ID="Button1" runat="server" BorderColor="Red" ForeColor="Red" 
                Text="Deterioration" Width="130px" /> Khulna, Rajshahi
            <br />
            <br />
            <asp:Button ID="Button2" runat="server" BorderColor="#006600" 
                ForeColor="#009900" Text="Improvement" Width="130px" /> Sylhet, Dhaka, Chittagong, Barisal, Rangpur
