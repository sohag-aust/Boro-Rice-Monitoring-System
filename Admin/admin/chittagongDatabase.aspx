<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chittagongDatabase.aspx.cs" Inherits="admin_chittagongDatabase" %>
...
<body>
    ...
    <div style="text-align: center">
        ...
        <asp:Label ID="Label1" runat="server" Text="Chittagong Division Database" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [Chittagong]"></asp:SqlDataSource>
    </form>
</body>
</html>