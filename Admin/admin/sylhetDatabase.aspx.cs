...
public partial class admin_sylhetDatabase : System.Web.UI.Page
{
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        String updatedata = "update Sylhet set year='" + year.Text + "', production='" + production.Text + "' where id=" + id.Text;
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        String mycon = "Data Source=.\\SQLEXPRESS;AttachDbFilename=D:\\ASP CHARTS\\Admin\\App_Data\\RiceDatabase.mdf;Integrated Security=True;User Instance=True";
        String updatedata = "delete from Sylhet where id=" + id.Text;
