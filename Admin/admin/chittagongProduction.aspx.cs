...
public partial class admin_chittagongProduction : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cmd1.CommandText = "truncate table Chittagong";
        ...
        while (dr.Read())
        {
            ...
            cmd1.CommandType = CommandType.Text;
            cmd1.CommandText = "insert into Chittagong (Year, Production) values('" + y + "','" + p + "')";
        ...
        Response.Redirect("chittagongDatabase.aspx");
    }
}