...
public partial class admin_dhakaProduction : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cmd1.CommandText = "truncate table Dhaka";
        ...
        while (dr.Read())
        {
            ...
            cmd1.CommandType = CommandType.Text;
            cmd1.CommandText = "insert into Dhaka (Year, Production) values('" + y + "','" + p + "')";
        ...
        Response.Redirect("dhakaDatabase.aspx");
    }
}