...
public partial class admin_rajshahiProduction : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cmd1.CommandText = "truncate table Rajshahi";
        ...
        while (dr.Read())
        {
            ...
            cmd1.CommandType = CommandType.Text;
            cmd1.CommandText = "insert into Rajshahi (Year, Production) values('" + y + "','" + p + "')";
        ...
        Response.Redirect("rajshahiDatabase.aspx");
    }
}