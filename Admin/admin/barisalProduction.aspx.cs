...
public partial class admin_barisalProduction : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cmd1.CommandText = "truncate table Barisal";
        ...
        while (dr.Read())
        {
            ...
            cmd1.CommandType = CommandType.Text;
            cmd1.CommandText = "insert into Barisal (Year, Production) values('" + y + "','" + p + "')";
        ...
        Response.Redirect("barisalDatabase.aspx");
    }
}